...
export const loadRecipe = async function (id) {
  try {
    ...
    //store recipe in state object above
...
export const updateServings = function (newServings) {
  state.recipe.ingredients.forEach(
    ingred =>
      (ingred.quantity =
        (ingred.quantity / state.recipe.servings) * newServings)
  );
...
export const addBookmark = function (recipe) {
  ...
  // const recipeString = JSON.stringify(state.bookmarks);
  // window.localStorage.setItem('bookmarks', recipeString);
};
